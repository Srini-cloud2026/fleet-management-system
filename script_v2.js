...
function renderFleetGrid(categoryFilter = null) {
    ...
    // Generate unique categories (defensive check for column names)
    const categories = [...new Set(vehicleMasterData
        .map(v => {
            const val = v['Category '] || v['category'] || 'Other';
    ...
    categories.forEach(cat => {
        ...
        const displayName = firstMatch ? (firstMatch['Category '] || firstMatch['category'] || 'Other').toString().trim() : 'Other';
