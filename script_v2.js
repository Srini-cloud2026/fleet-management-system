...
async function fetchGpsData() {
    ...
    try {
        ...
        if (topBar && !document.getElementById('debug-version')) {
            topBar.insertAdjacentHTML('beforeend', `<span id="debug-version" style="font-size:10px; margin-left:10px; opacity:0.5; color: var(--text-muted)">v2.7-Ready</span>`);
        } else if (document.getElementById('debug-version')) {
            document.getElementById('debug-version').textContent = 'v2.7-Ready';
        }
