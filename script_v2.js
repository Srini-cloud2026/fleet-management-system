...
async function loadVehicleData() {
    ...
    try {
        ...
        if (topBar) {
            ...
            stamp.style = 'font-size:12px; margin-left:15px; padding: 2px 8px; border-radius: 4px; background: var(--accent-blue); color: white; font-weight: bold;';
            stamp.textContent = 'v3.0-SUPER';
